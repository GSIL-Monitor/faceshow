package com.faceshow.modules.friend.vo;
 ...
 * 附近动态使用
 * -------------------------------------------------------------- <br>
 * V1.0 Created by 赵成贵 on 2018/4/9 16:38
 * -------------------------------------------------------------- <br>
 */
public class FriendRingSelectRowVo implements Serializable {
