...
public class JpTest {
    ...
    private static final String MASTER_SECRET = "7bd78864fa9da9351877f68f";// ;//必填，每个应用都对应一个MASTER_SECRET
    /**
     * 给所有平台的所有用户发通知 
     */
    ...
    public static void sendAllsetNotification(String message)
    {
        ...
        JPushClient jpushClient = new JPushClient(MASTER_SECRET, APP_KEY);//第一个参数是MASTER_SECRET 第二个是APP_KEY  
...
//      sendAlias.add("1001");  
//      new JpTest().sendAlias("这是java后台发送的一个按照alia的通知", sendAlias);
       // sendAllsetNotification("看看我是谁");
