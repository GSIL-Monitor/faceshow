...
import com.faceshow.common.utils.push.android.*;
import com.faceshow.common.utils.push.ios.*;
...
public class Demo {
	...
	public void sendAndroidBroadcast() throws Exception {
		...
		broadcast.setTicker( "Android 测试 broadcast ticker");
		broadcast.setTitle(  "中文的 测试  title");
		broadcast.setText(   "Android  测试 broadcast text");
	...
	public void sendAndroidUnicast() throws Exception {
		...
		unicast.setTicker( "123123213");
		unicast.setTitle(  "123123213");
		unicast.setText(   "123123213");
		unicast.setCustomField("test");
	...
	public static void main(String[] args) {
		...
		try {
			...
			demo.sendAndroidBroadcast(); //全部推送
			demo.sendIOSBroadcast();
			demo.sendIOSUnicast();
